<template lang='pug'>
  div#app
    div.live2d-panel
      ...
      live2d(v-if="islive2d" :width="200" :modelPath="modelPath" ref='l2dMange')
    div.tools-panel
...
<script>
import custom from 'common/js/live/custom'

export default {
  name: 'liveTo',
  data: () => ({
    modelPath: '/static/live/koharu/model.json',
